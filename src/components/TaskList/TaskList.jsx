  ...
  return (
    <div id='TaskListContainer' className='w-full h-1/2 flex flex-col md:flex-row flex-nowrap items-center justify-start gap-4 overflow-x-auto py-4'>
      {tasks.map((e)=>{
        if(e.new_task){
          return(
            <div className='w-full md:w-1/4 h-full bg-red-500 rounded-lg p-6 flex shrink-0 flex-col justify-start items-start gap-2'>
        ...
        if(e.completed){
          return(
            <div className='w-full md:w-1/4 h-full bg-yellow-500 rounded-lg p-6 flex shrink-0 flex-col justify-start items-start gap-2'>
              <div className='w-full flex items-center justify-between'>
                <h3 className='bg-red-500 py-2 px-4 rounded-sm'>High</h3>
                <h3>8 July 2025</h3>
              </div>
